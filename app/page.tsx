          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-foreground/70 text-lg mb-6 leading-relaxed">
                With over 15 years of experience in international commerce,
                Maniks International has established itself as a trusted partner
                for businesses seeking reliable import-export solutions. Our
                commitment to excellence, transparency, and customer
                satisfaction sets us apart in the competitive global trade
                landscape.
              </p>
            ...
            {/* Right Image */}
            <div className="relative h-full rounded-xl border border-border overflow-hidden group">
              <Image
                src="/images/2152005506.jpg"
                ...
                priority={false}
              />
              <div className="absolute inset-0 bg-gradient-accent opacity-30 group-hover:opacity-40 transition-opacity" />
            </div>
          </div>
        </ScrollSection>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={benefit}
                className="flex items-start gap-4 p-6 bg-card rounded-lg border border-border hover:border-accent/50 transition-colors"
              >
