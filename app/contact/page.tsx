...
export const metadata = {
  ...
  description: 'Reach out to our team for inquiries, quotes, or partnership opportunities. 24/7 support available.',
}
...
export default function Contact() {
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['info@maniks.com', 'support@maniks.com'],
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 md:pb-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-card/50 to-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-foreground/70 text-balance">
            Have questions or ready to transform your trade operations? Our team is here to help.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info) => (
              <div key={info.title} className="p-6 bg-card/50 rounded-lg border border-border hover:border-accent/50 transition-colors">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <details key={i} className="group p-6 bg-card/50 rounded-lg border border-border cursor-pointer hover:border-accent/50 transition-colors">
      ...
      <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-card/30">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Global Offices</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { city: 'New York, USA', phone: '+1 (555) 123-4567' },
              { city: 'London, UK', phone: '+44 (0) 20 7946 0958' },
              { city: 'Singapore', phone: '+65 6511 8888' },
              { city: 'Shanghai, China', phone: '+86 21 5888 8888' },
              { city: 'Dubai, UAE', phone: '+971 4 308 3333' },
              { city: 'Mumbai, India', phone: '+91 22 6669 1111' },
            ].map((location) => (
              <div key={location.city} className="p-6 bg-background rounded-lg border border-border">
                <h3 className="text-lg font-bold text-foreground mb-2">{location.city}</h3>
