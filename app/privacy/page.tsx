          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  Information you provide directly when requesting quotes,
                  making purchases, or contacting us
                </li>
                <li>
                ...
                <li>
                  Information from third parties such as business partners and
                  service providers
                </li>
                <li>
                ...
                <li>
                  Business information including company name, position, contact
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  ...
                  vendors who perform services on our behalf, subject to
                ...
                <li>
                  <strong>Aggregated Data:</strong> We may share aggregated,
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                encryption, firewalls, and secure servers to protect your
                personal information. However, no method of transmission over
                the Internet is 100% secure, and we cannot guarantee absolute
                security. You acknowledge and accept this risk when transmitting
                information to us.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  <strong>Session Cookies:</strong> Temporary cookies that help
                  us understand how you use our site
                </li>
                <li>
                  <strong>Persistent Cookies:</strong> Cookies that remain on
                  your device to remember preferences
                </li>
                <li>
                  <strong>Analytics:</strong> Tools to measure website
                  performance and user behavior
                </li>
                <li>
                  <strong>Marketing Cookies:</strong> To track conversion and
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                obligations, and resolve disputes. The retention period may vary
                depending on the context of the processing and our legal
                obligations.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                countries may have data protection laws that differ from your
                home country. By using our services, you consent to the transfer
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                continued use of our services following such notification
